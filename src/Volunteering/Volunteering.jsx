      ...
      <div className="inner">
        ...
        <div id="custom-grid">
          ...
          <div id="item-1">
            ...
            <br />
            <p>
              Almost a third of all the participants chose restaurants reviews
              as the main factor when looking for a resturant seconded by the
              price of the menu by one fourth of the participants. The other
              main factors to choose a restaurant were the culinary
              restrictions, the distance and the nationality of the food.
            </p>
          </div>
          <div id="item-6">
            <p>
              Secondly, users find it important to support their local
              restaurants rather than big chain franchises. On the other hand,
              when it comes to delivery, the users have no preference to whether
              or not it is delivered directly from the restaurant or by a 3rd
              party, like UberEats for example. They also believe that eating
              out at restaurants is much more important than ordering out, yet
              these results are very close to each other as each option has
            ...
            <p>
              ...
              important factor because the crowdedness of a restaurant will
              affect the user's decision if they would want to eat at said
              place.
            </p>
            <br />
            <br />
            <br />
            <p>
              Lastly, a large part of the decision making process for choices in
              a restaurant are the reviews other people give. This will help the
